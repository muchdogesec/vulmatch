...
def test_cve_stats(client, api_schema, patched_helper):
    ...
    assert data == {
        "total_count": 567,
        "modified_since": {"d1": 446, "d7": 484, "d30": 485, "d365": 567},
        ...
        "cvss_v3": [
            {"range_group": "undefined", "count": 30},
            ...
            {"range_group": "4.6 -  4.7", "count": 1},
            {"range_group": "4.7 -  4.8", "count": 7},
            {"range_group": "4.8 -  4.9", "count": 7},
            {"range_group": "4.9 -  5.0", "count": 1},
            {"range_group": "5.2 -  5.3", "count": 2},
            {"range_group": "5.3 -  5.4", "count": 22},
            {"range_group": "5.4 -  5.5", "count": 24},
            {"range_group": "5.5 -  5.6", "count": 147},
