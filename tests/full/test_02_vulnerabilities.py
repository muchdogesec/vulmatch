...
@pytest.mark.parametrize(
    ...
    [
        ...
        ["CVE-2024-53647", None, 105],
        ["CVE-2023-31025", None, 24],
        ##
        ["CVE-2024-53647", dict(include_capec=False), 51],
        ["CVE-2024-53647", dict(include_attack=False), 83],
        ["CVE-2023-31025", dict(include_capec=False), 24],
        ["CVE-2023-31025", dict(include_epss=False), 23],
        ["CVE-2024-53197", dict(include_kev=True), 5304],
        [
            "CVE-2024-53197",
            dict(include_kev=False),
            5302,
        ],  # subtract cisa and vulncheck kev (5304 - 2)
        [
            "CVE-2024-53197",
            dict(include_kev=False, include_epss=False),
            5301,
        ],  # subtract cisa and vulncheck kev (5304 - 2) and one epss report (5302 - 1)
        ["CVE-2024-53197", dict(include_x_cpes_not_vulnerable=False), 5304],
