...
@pytest.mark.parametrize(
    ...
    [
        ...
        [dict(product_type="operating-system", vendor='juniper', product="junos"), 1064],
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ["cpe:2.3:a:mongodb:c_driver:1.15.0:*:*:*:*:mongodb:*:*", dict(include_cves_vulnerable=False), 8],
        ["cpe:2.3:a:ays-pro:quiz_maker:1.1.0:*:*:*:*:wordpress:*:*", None, 15],
        ["cpe:2.3:a:ays-pro:quiz_maker:1.1.0:*:*:*:*:wordpress:*:*", dict(include_cves_vulnerable=False), 8],
        ["cpe:2.3:o:juniper:junos:23.1:-:*:*:*:*:*:*", None, 15],
        ["cpe:2.3:o:juniper:junos:23.1:-:*:*:*:*:*:*", dict(include_cves_vulnerable=False), 8],
        ["cpe:2.3:a:ays-pro:quiz_maker:5.2.1:*:*:*:*:wordpress:*:*", None, 15],
        ["cpe:2.3:a:ays-pro:quiz_maker:5.2.1:*:*:*:*:wordpress:*:*", dict(include_cves_vulnerable=False), 8],
        #####
        ["cpe:2.3:h:huawei:secospace_usg6600:-:*:*:*:*:*:*:*", dict(include_cves_vulnerable=False), 39],
        ["cpe:2.3:h:huawei:secospace_usg6600:-:*:*:*:*:*:*:*", dict(include_cves_not_vulnerable=False), 8],
